...
Taylor and Munro \cite{Taylor2002},  demonstrated that it is possible to use the data contained in a version control repository to visualize the evolution of a system.
